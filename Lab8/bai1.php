<?php
    require "PHPMailer.phpPHPMailer.php";  //nhúng thư viện vào để dùng, sửa lại đường dẫn cho đúng nếu bạn lưu vào chỗ khác
    ...
    $nguoigui = 'voquochoang2004@gmail.com';
    $matkhau = 'zgzisobsesekcqds';// mật khẩu của tài khoản ngolequanvh@gmail.com
